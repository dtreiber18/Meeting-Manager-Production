import { Component, Input, OnInit, OnDestroy, ViewChild, ElementRef, AfterViewChecked, ChangeDetectionStrategy } from '@angular/core';
...
export class AiChatComponent implements OnInit, OnDestroy, AfterViewChecked {
  ...
  sendMessage(): void {
    ...
    this.chatService.generateAIResponse(messageText, this.pageType)
